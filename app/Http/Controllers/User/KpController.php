...
class KpController extends Controller
{
    ...
    public function index()
    {
        ...
        if (!auth()->user()->is_admin) {
            ...
            return view('user.kps.index', compact('kps'));
        }
    ...
    public function store(StoreKpRequest $request)
    {
        ...
        return redirect()->route('user.kps.index');
    }
    ...
    public function edit(Kp $kp)
    {
        ...
        return view('user.kps.edit', compact('kp'));
    }
    ...
    public function show(Kp $kp)
    {
        ...
        return view('user.kps.show', compact('kp'));
    }
