                        ...
                        @foreach ($cms as $key => $cm)
                            <tr data-entry-id="{{ $cm->id }}">
                                ...
                                <td>
                                    ...
                                    <form action="{{ route('admin.cms.ubahstatus', $cm->id) }}" method="POST"
                                    ...
                                    <form action="{{ route('admin.cms.ubahstatust', $cm->id) }}" method="POST"
                                        onsubmit="return confirm('{{ trans('global.areYouSure') }}');"
                                        style="display: inline-block;">
                                        @method('PATCH')
                                        @csrf
                                    ...
                                    @can('cm_delete')
                                        <form action="{{ route('admin.cms.destroy', $cm->id) }}" method="POST"
                                            onsubmit="return confirm('{{ trans('global.areYouSure') }}');"
                                            style="display: inline-block;">
...
@section('scripts')
    ...
    <script>
        $(function() {
            ...
            let table = $('.datatable-Cm:not(.ajaxTable)').DataTable({
                buttons: dtButtons
            })
