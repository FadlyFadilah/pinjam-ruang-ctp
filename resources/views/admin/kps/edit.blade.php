...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.kps.update", [$kp->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                <label class="required" for="lama">{{ trans('cruds.kp.fields.lama') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.kp.fields.lama_helper') }}</span>
            </div>
            <div class="form-group">
