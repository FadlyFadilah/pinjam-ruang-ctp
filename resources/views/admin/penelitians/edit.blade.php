    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.penelitians.update", [$penelitian->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nama') ? 'is-invalid' : '' }}" type="text" name="nama" id="nama" value="{{ old('nama', $penelitian->nama) }}" required>
                @if($errors->has('nama'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('no_hp') ? 'is-invalid' : '' }}" type="text" name="no_hp" id="no_hp" value="{{ old('no_hp', $penelitian->no_hp) }}" required>
                @if($errors->has('no_hp'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="email" name="email" id="email" value="{{ old('email', $penelitian->email) }}" required>
                @if($errors->has('email'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('univ') ? 'is-invalid' : '' }}" type="text" name="univ" id="univ" value="{{ old('univ', $penelitian->univ) }}" required>
                @if($errors->has('univ'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('alamat') ? 'is-invalid' : '' }}" name="alamat" id="alamat">{{ old('alamat', $penelitian->alamat) }}</textarea>
            ...
            <div class="form-group">
                <label for="kesbang">{{ trans('cruds.penelitian.fields.kesbang') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.penelitian.fields.kesbang_helper') }}</span>
            </div>
            <div class="form-group">
