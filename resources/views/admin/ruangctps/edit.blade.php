    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.ruangctps.update", [$ruangctp->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('ruangan') ? 'is-invalid' : '' }}" name="ruangan_id" id="ruangan_id" required>
                    @foreach($ruangans as $id => $entry)
                        <option value="{{ $id }}" {{ (old('ruangan_id') ? old('ruangan_id') : $ruangctp->ruangan->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('skpd') ? 'is-invalid' : '' }}" name="skpd" id="skpd" required>
                    <option value disabled {{ old('skpd', null) === null ? 'selected' : '' }}>{{ trans('global.pleaseSelect') }}</option>
                    @foreach(App\Models\Ruangctp::SKPD_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('skpd', $ruangctp->skpd) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has('skpd'))
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('bidang_kegiatan') ? 'is-invalid' : '' }}" name="bidang_kegiatan" id="bidang_kegiatan" required>
                    <option value disabled {{ old('bidang_kegiatan', null) === null ? 'selected' : '' }}>{{ trans('global.pleaseSelect') }}</option>
                    @foreach(App\Models\Ruangctp::BIDANG_KEGIATAN_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('bidang_kegiatan', $ruangctp->bidang_kegiatan) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nama') ? 'is-invalid' : '' }}" type="text" name="nama" id="nama" value="{{ old('nama', $ruangctp->nama) }}" required>
                @if($errors->has('nama'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kelurahan') ? 'is-invalid' : '' }}" type="text" name="kelurahan" id="kelurahan" value="{{ old('kelurahan', $ruangctp->kelurahan) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kecamatan') ? 'is-invalid' : '' }}" type="text" name="kecamatan" id="kecamatan" value="{{ old('kecamatan', $ruangctp->kecamatan) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kota') ? 'is-invalid' : '' }}" type="text" name="kota" id="kota" value="{{ old('kota', $ruangctp->kota) }}" required>
                @if($errors->has('kota'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kodepos') ? 'is-invalid' : '' }}" type="text" name="kodepos" id="kodepos" value="{{ old('kodepos', $ruangctp->kodepos) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('no') ? 'is-invalid' : '' }}" type="text" name="no" id="no" value="{{ old('no', $ruangctp->no) }}" required>
                @if($errors->has('no'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ktp') ? 'is-invalid' : '' }}" type="text" name="ktp" id="ktp" value="{{ old('ktp', $ruangctp->ktp) }}" required>
                @if($errors->has('ktp'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('instansi') ? 'is-invalid' : '' }}" type="text" name="instansi" id="instansi" value="{{ old('instansi', $ruangctp->instansi) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('statusdiinstansi') ? 'is-invalid' : '' }}" type="text" name="statusdiinstansi" id="statusdiinstansi" value="{{ old('statusdiinstansi', $ruangctp->statusdiinstansi) }}">
            ...
            <div class="form-group">
                <label class="required" for="bidanginstansi">{{ trans('cruds.ruangctp.fields.bidanginstansi') }}</label>
                <input class="form-control {{ $errors->has('bidanginstansi') ? 'is-invalid' : '' }}" type="text" name="bidanginstansi" id="bidanginstansi" value="{{ old('bidanginstansi', $ruangctp->bidanginstansi) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('alamatinstansi') ? 'is-invalid' : '' }}" name="alamatinstansi" id="alamatinstansi">{{ old('alamatinstansi', $ruangctp->alamatinstansi) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('mulai') ? 'is-invalid' : '' }}" type="text" name="mulai" id="mulai" value="{{ old('mulai', $ruangctp->mulai) }}" required>
                @if($errors->has('mulai'))
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('mulaijam') ? 'is-invalid' : '' }}" type="text" name="mulaijam" id="mulaijam" value="{{ old('mulaijam', $ruangctp->mulaijam) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('selesai') ? 'is-invalid' : '' }}" type="text" name="selesai" id="selesai" value="{{ old('selesai', $ruangctp->selesai) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('selesaijam') ? 'is-invalid' : '' }}" type="text" name="selesaijam" id="selesaijam" value="{{ old('selesaijam', $ruangctp->selesaijam) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nama_acara') ? 'is-invalid' : '' }}" type="text" name="nama_acara" id="nama_acara" value="{{ old('nama_acara', $ruangctp->nama_acara) }}" required>
            ...
            <div class="form-group">
                <label class="required" for="jumlah_peserta">{{ trans('cruds.ruangctp.fields.jumlah_peserta') }}</label>
                <input class="form-control {{ $errors->has('jumlah_peserta') ? 'is-invalid' : '' }}" type="text" name="jumlah_peserta" id="jumlah_peserta" value="{{ old('jumlah_peserta', $ruangctp->jumlah_peserta) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('narasumber') ? 'is-invalid' : '' }}" type="text" name="narasumber" id="narasumber" value="{{ old('narasumber', $ruangctp->narasumber) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('outpu') ? 'is-invalid' : '' }}" type="text" name="outpu" id="outpu" value="{{ old('outpu', $ruangctp->outpu) }}">
                @if($errors->has('outpu'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('outcome') ? 'is-invalid' : '' }}" type="text" name="outcome" id="outcome" value="{{ old('outcome', $ruangctp->outcome) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('ringkasan') ? 'is-invalid' : '' }}" name="ringkasan" id="ringkasan" required>{{ old('ringkasan', $ruangctp->ringkasan) }}</textarea>
            ...
            <div class="form-group">
                <label class="required" for="surat_permohonan">{{ trans('cruds.ruangctp.fields.surat_permohonan') }}</label>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Ruangctp::RUNDOWN_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('rundown') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="rundown_{{ $key }}" name="rundown" value="{{ $key }}" {{ old('rundown', $ruangctp->rundown) === (string) $key ? 'checked' : '' }}>
                        <label class="form-check-label" for="rundown_{{ $key }}">{{ $label }}</label>
                    </div>
                @endforeach
            ...
            <div class="form-group">
                ...
                <div class="needsclick dropzone {{ $errors->has('rundown_proposal') ? 'is-invalid' : '' }}" id="rundown_proposal-dropzone">
                </div>
            ...
            <div class="form-group">
                ...
                <div class="needsclick dropzone {{ $errors->has('rundown_barang') ? 'is-invalid' : '' }}" id="rundown_barang-dropzone">
                </div>
            ...
            <div class="form-group">
                ...
                <div class="needsclick dropzone {{ $errors->has('rundown_persiapan') ? 'is-invalid' : '' }}" id="rundown_persiapan-dropzone">
                </div>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Ruangctp::GLADIRESIK_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('gladiresik') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="gladiresik_{{ $key }}" name="gladiresik" value="{{ $key }}" {{ old('gladiresik', $ruangctp->gladiresik) === (string) $key ? 'checked' : '' }}>
                        <label class="form-check-label" for="gladiresik_{{ $key }}">{{ $label }}</label>
                    </div>
                @endforeach
