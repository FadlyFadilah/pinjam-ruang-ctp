...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.peminjamanCh.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.peminjaman-ches.update", [$peminjamanCh->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ktp') ? 'is-invalid' : '' }}" type="text" name="ktp" id="ktp" value="{{ old('ktp', $peminjamanCh->ktp) }}" required>
                @if($errors->has('ktp'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('alamat') ? 'is-invalid' : '' }}" name="alamat" id="alamat">{{ old('alamat', $peminjamanCh->alamat) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('no_hp') ? 'is-invalid' : '' }}" type="text" name="no_hp" id="no_hp" value="{{ old('no_hp', $peminjamanCh->no_hp) }}" required>
                @if($errors->has('no_hp'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="email" name="email" id="email" value="{{ old('email', $peminjamanCh->email) }}" required>
                @if($errors->has('email'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tujuan') ? 'is-invalid' : '' }}" type="text" name="tujuan" id="tujuan" value="{{ old('tujuan', $peminjamanCh->tujuan) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('booking') ? 'is-invalid' : '' }}" type="text" name="booking" id="booking" value="{{ old('booking', $peminjamanCh->booking) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('selesai') ? 'is-invalid' : '' }}" type="text" name="selesai" id="selesai" value="{{ old('selesai', $peminjamanCh->selesai) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jumlah') ? 'is-invalid' : '' }}" type="number" name="jumlah" id="jumlah" value="{{ old('jumlah', $peminjamanCh->jumlah) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\PeminjamanCh::INFOKUS_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('infokus') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="infokus_{{ $key }}" name="infokus" value="{{ $key }}" {{ old('infokus', $peminjamanCh->infokus) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('persetujuan') ? 'is-invalid' : '' }}">
                    <input class="form-check-input" type="checkbox" name="persetujuan" id="persetujuan" value="1" {{ $peminjamanCh->persetujuan || old('persetujuan', 0) === 1 ? 'checked' : '' }} required>
                    <label class="required form-check-label" for="persetujuan">{{ trans('cruds.peminjamanCh.fields.persetujuan') }}</label>
                </div>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('persetujuan_2') ? 'is-invalid' : '' }}">
                    <input class="form-check-input" type="checkbox" name="persetujuan_2" id="persetujuan_2" value="1" {{ $peminjamanCh->persetujuan_2 || old('persetujuan_2', 0) === 1 ? 'checked' : '' }} required>
                    <label class="required form-check-label" for="persetujuan_2">{{ trans('cruds.peminjamanCh.fields.persetujuan_2') }}</label>
                </div>
