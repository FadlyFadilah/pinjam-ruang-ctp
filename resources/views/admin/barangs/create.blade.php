        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.barangs.store') }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('nama_barang') ? 'is-invalid' : '' }}" type="text"
                        name="nama_barang" id="nama_barang" value="{{ old('nama_barang', '') }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('kapasitas') ? 'is-invalid' : '' }}" type="number"
                        name="kapasitas" id="kapasitas" value="{{ old('kapasitas', '0') }}" step="1">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('lokasi') ? 'is-invalid' : '' }}" type="text"
                ...
                <div class="form-group">
                    ...
                    <select class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" name="status" id="status">
                        ...
                        @foreach(App\Models\Ruangan::STATUS_SELECT as $key => $label)
                            <option value="{{ $key }}" {{ old('status', 'Tidak Tersedia') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach
                    </select>
