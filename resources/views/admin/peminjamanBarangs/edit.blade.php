...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.peminjamanBarang.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.peminjaman-barangs.update", [$peminjamanBarang->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('barang') ? 'is-invalid' : '' }}" name="barang_id" id="barang_id" required>
                    @foreach($barangs as $id => $entry)
                        <option value="{{ $id }}" {{ (old('barang_id') ? old('barang_id') : $peminjamanBarang->barang->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nama_usaha') ? 'is-invalid' : '' }}" type="text" name="nama_usaha" id="nama_usaha" value="{{ old('nama_usaha', $peminjamanBarang->nama_usaha) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('alamat') ? 'is-invalid' : '' }}" name="alamat" id="alamat">{{ old('alamat', $peminjamanBarang->alamat) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $peminjamanBarang->name) }}" required>
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ktp') ? 'is-invalid' : '' }}" type="text" name="ktp" id="ktp" value="{{ old('ktp', $peminjamanBarang->ktp) }}" required>
                @if($errors->has('ktp'))
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('booking') ? 'is-invalid' : '' }}" type="text" name="booking" id="booking" value="{{ old('booking', $peminjamanBarang->booking) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tujuan') ? 'is-invalid' : '' }}" type="text" name="tujuan" id="tujuan" value="{{ old('tujuan', $peminjamanBarang->tujuan) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('no_hp') ? 'is-invalid' : '' }}" type="text" name="no_hp" id="no_hp" value="{{ old('no_hp', $peminjamanBarang->no_hp) }}" required>
                @if($errors->has('no_hp'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="email" name="email" id="email" value="{{ old('email', $peminjamanBarang->email) }}" required>
                @if($errors->has('email'))
