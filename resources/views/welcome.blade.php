        ...
        <div class="container">
            <div class="row no-gutters">
                ...
                <div class="col-md-6 wrap-about ftco-animate">
                    ...
                    <div class="pl-md-5">
                        <p>Cimahi Technopark menawarkan beberapa fasilitas bernilai tambah yang dapat digunakan oleh Tenant Binaan dan UKM inovatif yang berdomisili di Kota Cimahi</p>
                        <div class="row">
                            <div class="services-2 col-lg-6 d-flex w-100">
                                ...
                                <div class="media-body pl-3">
                                    ...
                                    <p>Studio Dubbing berada di Gedung BITC yang diperuntukan bagi Tenant BITC dan Tenant Binaan Sektor Animasi atau yang membutuhkan Aset Suara untuk Pengisian Promosi Produk Secara Digital</p>
                                </div>
                            </div>
                            <div class="services-2 col-lg-6 d-flex w-100">
                                <div class="icon d-flex justify-content-center align-items-center">
            ...
            <div class="row no-gutters justify-content-around">
                <div class="card col-lg-4 col-md-6">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Peminjaman / Penyewaan Ruangan yang Berada DI Gedung BITC dan CTP serta Pendaftaran Fasilitas
                             Foto Produk</p>
            ...
            <div class="col-sm text-center">
                ...
                <div class="row justify-content-center">
                    <div class="col-sm-6 col-md-3 mb-3">
                        <a href="{{ route('login') }}" class="btn btn-white btn-block">Studio Foto</a>
                    </div>
                    <div class="col-sm-6 col-md-3 mb-3">
                        <a href="{{ route('login') }}" class="btn btn-white btn-block">Penelitian</a>
                    </div>
                    <div class="col-sm-6 col-md-3 mb-3">
                        <a href="{{ route('login') }}" class="btn btn-white btn-block">Kerja Praktek</a>
                    </div>
                    <div class="col-sm-6 col-md-3 mb-3">
                        <a href="{{ route('login') }}" class="btn btn-white btn-block">Praktek Kerja Lapangan</a>
                    </div>
                </div>
            </div>
        </div>
