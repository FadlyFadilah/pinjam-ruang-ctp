            ...
            <div class="row justify-content-center">
                <div class="col-sm text-center">
                    ...
                    <p class="mb-0">
                        ...
                        <a href="{{ route('login') }}" class="btn btn-white px-4 py-3">Penelitian</a>
                        <a href="{{ route('login') }}" class="btn btn-white px-4 py-3">Kerja Praktek</a>
                        <a href="{{ route('login') }}" class="btn btn-white px-4 py-3">Praktek Kerja Lapangan</a>
                    </p>
                </div>
            </div>
        </div>
