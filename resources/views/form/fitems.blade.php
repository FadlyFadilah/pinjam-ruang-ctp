      ...
      <div class="row no-gutters slider-text align-items-center justify-content-center">
        <div class="col-md-9 ftco-animate text-center">
            <p class="breadcrumbs mb-2">
                ...
                <span class="mr-2">
                    <a href="{{ route('items') }}">Barang <i class="fa fa-chevron-right"></i></a>
                </span>  
                <span>
                    Barang<i class="fa fa-chevron-right"></i>
                </span></p>
          <h1 class="mb-0 bread">Form Pinjam Barang</h1>
        </div>
      </div>
    </div>
  </section>
			...
			<div class="col-md-10 offset-md-1">
				...
				<div class="form-row mt-4">
                    ...
                    <div class="col-sm-12 pb-3">
						<label for="exampleLast">Nama Usaha</label>
						<input type="text" class="form-control" id="exampleLast">
					</div>
					<div class="col-sm-12 pb-3">
					...
					<div class="col-sm-12 pb-3">
						<label for="exampleium">Tujuan Booking</label>
