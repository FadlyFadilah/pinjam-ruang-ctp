    ...
    <div class="container">
      <div class="row no-gutters slider-text align-items-center justify-content-center">
        <div class="col-md-9 ftco-animate text-center">
            <p class="breadcrumbs mb-2"><span class="mr-2"><a href="{{ route('home') }}">Beranda <i class="fa fa-chevron-right"></i></a></span> <span>Studio Foto <i class="fa fa-chevron-right"></i></span></p>
          <h1 class="mb-0 bread">Form Daftar Studio Foto</h1>
        </div>
      </div>
    </div>
  </section>
		...
		<div class="row no-gutters">
			<div class="col-md-10 offset-md-1">
				...
				<div class="form-row mt-4">
					...
					<div class="col-sm-12 pb-3">
						<label for="exampleFirst">No. HP</label>
						<input type="text" class="form-control" id="examplephone">
					</div>
					<div class="col-sm-6 pb-3">
						<label for="examplepname">Nama Produk</label>
						<input type="text" class="form-control" id="examplepname">
					</div>
					<div class="col-sm-6 pb-3">
						<label for="examplepcluster">Klaster Produk</label>
						<input type="text" class="form-control" id="examplepcluster">
					</div>
					<div class="col-sm-12 pb-3">
						<label for="exampleomzet">Perkiraan Omzet</label>
						<input type="text" class="form-control" id="exampleomzet">
					</div>
					<div class="col-sm-12 pb-3">
						<label for="exampleprofil">Profil</label>
						<input type="text" class="form-control" id="exampleprofil">
					</div>
					<div class="col-sm-12 pb-3">
					...
					<div class="col-sm-12 pb-3">
						<label for="exampleium">IUM</label>
