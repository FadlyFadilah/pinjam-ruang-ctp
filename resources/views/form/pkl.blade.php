        ...
        <div class="container">
            <div class="row no-gutters slider-text align-items-center justify-content-center">
                <div class="col-md-9 ftco-animate text-center">
                    <p class="breadcrumbs mb-2"><span class="mr-2"><a href="">Beranda <i
                                    class="fa fa-chevron-right"></i></a></span> <span>Praktek Kerja Lapangan<i
                                class="fa fa-chevron-right"></i></span></p>
                    <h1 class="mb-0 bread">Form Daftar Praktek Kerja Lapangan</h1>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row no-gutters">
                <div class="col-md-10 offset-md-1">
                    ...
                    <hr class="my-5">
                    <h3>Pendaftaran Praktek Kerja Lapangan</h3>
                    ...
                    <div class="form-row mt-4">
                        ...
                        <div class="col-sm-6 pb-3">
                            <label for="examplepname">Asal Sekolah</label>
                            <input type="text" class="form-control" id="examplepname">
                        </div>
                        <div class="col-sm-6 pb-3">
                            <label for="examplepcluster">Lama Praktek Kerja Lapangan</label>
