        ...
        <div class="card-body">
            <div class="bs-stepper">
                ...
                <div class="bs-stepper-content">
                    ...
                    <form method="POST" action="{{ route('user.peminjaman-studio-dubbings.store') }}"
                        ...
                        <div id="data" class="content" role="tabpanel" aria-labelledby="data-trigger">
                            <div class="form-group">
                                <label class="required"
                                    for="nama">{{ trans('cruds.peminjamanStudioDubbing.fields.nama') }}</label>
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.peminjamanStudioDubbing.fields.nama_helper') }}</span>
                            </div>
                            <div class="form-group">
                                <label class="required"
                                    for="ktp">{{ trans('cruds.peminjamanStudioDubbing.fields.ktp') }}</label>
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.peminjamanStudioDubbing.fields.ktp_helper') }}</span>
                            </div>
                            <div class="form-group">
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.peminjamanStudioDubbing.fields.alamat_helper') }}</span>
                            </div>
                            <div class="form-group">
                                <label class="required"
                                    for="no_hp">{{ trans('cruds.peminjamanStudioDubbing.fields.no_hp') }}</label>
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.peminjamanStudioDubbing.fields.no_hp_helper') }}</span>
                            </div>
                            <div class="form-group">
                                <label class="required"
                                    for="email">{{ trans('cruds.peminjamanStudioDubbing.fields.email') }}</label>
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.peminjamanStudioDubbing.fields.email_helper') }}</span>
                            </div>
                            <div class="form-group">
                                <label class="required"
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.peminjamanStudioDubbing.fields.booking_helper') }}</span>
                            </div>
                            <div class="form-group">
                                <label
                                    for="selesai_booking">{{ trans('cruds.peminjamanStudioDubbing.fields.selesai_booking') }}</label>
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.peminjamanStudioDubbing.fields.selesai_booking_helper') }}</span>
                            </div>
                            <div class="form-group">
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.peminjamanStudioDubbing.fields.operator_helper') }}</span>
                            </div>
                            <div class="form-group">
                                <div class="form-check {{ $errors->has('persetujuan') ? 'is-invalid' : '' }}">
                                    ...
                                    <label class="required form-check-label" for="persetujuan">Dengan ini saya
                                        bertanggung jawab atas kualitas dan kuantitas sarana dan prasarana pda Studio
                                        Dubbing Selama Masa Peminjaman. Dan Bersedia untuk Bertanggung Jawab apabila ada
                                        kerusakan/kehilangan</label>
                                </div>
                                @if ($errors->has('persetujuan'))
                                    <span class="text-danger">{{ $errors->first('persetujuan') }}</span>
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.peminjamanStudioDubbing.fields.persetujuan_helper') }}</span>
                            </div>
                            <div class="form-group">
