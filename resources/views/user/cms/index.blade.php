                ...
                <div class="bs-stepper">
                    <div class="bs-stepper-header" role="tablist">
                        ...
                        <div class="step" data-target="#data">
                            <button type="button" class="step-trigger" role="tab" aria-controls="data"
                                id="data-trigger">
                    ...
                    <div class="bs-stepper-content">
                        ...
                        <form method="POST" action="{{ route('user.cms.store') }}" enctype="multipart/form-data">
                            ...
                            <div id="alur" class="content" role="tabpanel" aria-labelledby="alur-trigger">
                                <h1>SOP</h1>
                                <p>
                                    1. Yang akan mendaftarkan Cimahi Maker Space, wajib mengisi formulir di website :
                                    http://pelita.cimahitechnopark.id/ .<br>
                                    2. Setelah mengisi formulir di website, calon peserta CMS wajib mengikuti seleksi talent
                                    scouting (menyerahkan portfolio) ke tim Publikasi.<br>
                                    3. Setelah mengikuti talent scouting peserta yang lolos akan di panggil untuk mengikuti
                                    seleksi pitching project dengan Mentor. <br>
                                    4. Peserta yang lolos berhak mengikuti program Cimahi Maker Space selama 1 (satu)
                                    tahun.<br>
                                    5. Dalam Program Cimahi Maker Space, peserta Cimahi Maker Space wajib mengikuti kegiatan
                                    diantaranya Workshop 4x dalam setahun,Bootcamp Satu Tahun Hanya 1x, dan Evaluasi Setiap
                                    Bulan.<br>
                                    6. Setelah melakukan program Cimahi Maker Space selama 1 (satu) tahun, di akhir kegiatan
                                    akan ada penilaian akhir dan Kegiatan Maneuver Day di akhir kegiatan, untuk
                                    memperlihatkan hasil karya peserta Cimahi Maker Space.
                                </p>
                                ...
                                <button id="nextButton" class="btn btn-primary" onclick="stepper.next()"
                            ...
                            <div id="data" class="content" role="tabpanel" aria-labelledby="data-trigger">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control {{ $errors->has('no') ? 'is-invalid' : '' }}"
                                        type="text" name="no" id="no" value="{{ old('no', '') }}"
                                        required>
                                    @if ($errors->has('no'))
