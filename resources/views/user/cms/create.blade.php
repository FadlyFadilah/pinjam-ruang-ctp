    ...
    <div class="card-body">
        <form method="POST" action="{{ route("user.cms.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('asal_sekolah') ? 'is-invalid' : '' }}" type="text" name="asal_sekolah" id="asal_sekolah" value="{{ old('asal_sekolah', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jurusan') ? 'is-invalid' : '' }}" type="text" name="jurusan" id="jurusan" value="{{ old('jurusan', '') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('ketertarikan') ? 'is-invalid' : '' }}" name="ketertarikan" id="ketertarikan" required>{{ old('ketertarikan') }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sosmed') ? 'is-invalid' : '' }}" type="text" name="sosmed" id="sosmed" value="{{ old('sosmed', '') }}">
