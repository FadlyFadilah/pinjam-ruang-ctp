        ...
        <div class="card-body">
            <div class="bs-stepper">
                ...
                <div class="bs-stepper-content">
                    ...
                    <form method="POST" id="form" action="{{ route('user.ruangctps.store') }}"
                        ...
                        <div id="informasi-acara" class="content" role="tabpanel"
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control {{ $errors->has('mulai') ? 'is-invalid' : '' }}"
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control {{ $errors->has('selesai') ? 'is-invalid' : '' }}"
