    ...
    <div class="card-body">
        <form method="POST" action="{{ route("user.peminjaman-ches.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('selesai') ? 'is-invalid' : '' }}" type="text" name="selesai" id="selesai" value="{{ old('selesai') }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('persetujuan_2') ? 'is-invalid' : '' }}">
                    <input class="form-check-input" type="checkbox" name="persetujuan_2" id="persetujuan_2" value="1" required {{ old('persetujuan_2', 0) == 1 ? 'checked' : '' }}>
