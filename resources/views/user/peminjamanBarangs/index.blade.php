        ...
        <div class="card-body">
            <div class="bs-stepper">
                ...
                <div class="bs-stepper-content">
                    ...
                    <form method="POST" action="{{ route('user.peminjaman-barangs.store') }}"
                        ...
                        <div id="data" class="content" role="tabpanel" aria-labelledby="data-trigger">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2 {{ $errors->has('barang') ? 'is-invalid' : '' }}" name="barang_id"
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control {{ $errors->has('nama_usaha') ? 'is-invalid' : '' }}" type="text"
                                    name="nama_usaha" id="nama_usaha" value="{{ old('nama_usaha', '') }}" required>
